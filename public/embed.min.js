(function(){
  ...
  var iframe=document.createElement('iframe'); iframe.className='bml-chat-frame'; iframe.src=appOrigin+'/chatbot'; iframe.title='BookmyLead Chatbot'; iframe.width=(bubbleSize==='sm'?'64':'80'); iframe.height=(bubbleSize==='sm'?'64':'80'); iframe.style.background='transparent'; iframe.style.colorScheme='normal'; iframe.allowTransparency='true';

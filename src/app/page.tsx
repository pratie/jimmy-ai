  ...
  return (
    <main className="bg-transparent min-h-screen">
      ...
      <section className="relative overflow-hidden bg-transparent">
          ...
          <span className="text-text-primary bg-pastel-pink/60 backdrop-blur-sm px-6 py-3 rounded-full text-sm font-semibold border-2 border-interactive-pink/30 shadow-sm">
          ...
          <div className="text-center space-y-6">
            ...
            <p className="text-text-secondary text-lg md:text-xl max-w-[600px] mx-auto leading-relaxed">
              ...
              <span className="text-text-primary font-bold"> Stop losing customers. Start closing deals.</span>
            </p>
          </div>
          ...
          <div className="mt-12 relative">
              ...
              className="max-w-4xl object-contain relative z-10 drop-shadow-2xl rounded-2xl border-4 border-pastel-lavender/50 bg-white/50 backdrop-blur-sm p-2"
            />
          </div>
        </div>
      </section>
      ...
      <section className="bg-transparent py-20 mt-20" id="features">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-12">
            ...
            <div className="bg-pastel-cream/80 backdrop-blur-md p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 border-2 border-pastel-lavender/50 hover:border-interactive-pink/50 hover:scale-105">
              <div className="w-14 h-14 bg-interactive-pink/30 rounded-full flex items-center justify-center mb-6">
              ...
              <h3 className="text-xl font-bold text-text-primary mb-3">Never Miss a Lead Again</h3>
              ...
              <p className="text-text-primary font-semibold bg-interactive-pink/20 px-3 py-1 rounded-lg inline-block">
                Average result: 3x more qualified leads per month
              </p>
            </div>

            {/* Feature 2: Appointment Booking */}
            <div className="bg-pastel-sky/70 backdrop-blur-md p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 border-2 border-pastel-periwinkle/50 hover:border-interactive-blue/50 hover:scale-105">
              <div className="w-14 h-14 bg-interactive-blue/30 rounded-full flex items-center justify-center mb-6">
                <svg className="w-7 h-7 text-text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                </svg>
              </div>
              <h3 className="text-xl font-bold text-text-primary mb-3">Stop Playing Phone Tag</h3>
              <p className="text-text-secondary mb-4">
              ...
              <p className="text-text-primary font-semibold bg-interactive-blue/20 px-3 py-1 rounded-lg inline-block">
                Save 15+ hours per week on scheduling
              </p>
            </div>

            {/* Feature 3: Instant Support */}
            <div className="bg-pastel-mint/70 backdrop-blur-md p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 border-2 border-pastel-mint/50 hover:border-interactive-mint/50 hover:scale-105">
              <div className="w-14 h-14 bg-interactive-mint/30 rounded-full flex items-center justify-center mb-6">
                <svg className="w-7 h-7 text-text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" />
                </svg>
              </div>
              <h3 className="text-xl font-bold text-text-primary mb-3">Answer Questions Before They Bounce</h3>
              <p className="text-text-secondary mb-4">
              ...
              <p className="text-text-primary font-semibold bg-interactive-mint/20 px-3 py-1 rounded-lg inline-block">
                Reduce bounce rate by up to 40%
              </p>
            </div>

            {/* Feature 4: Email Marketing */}
            <div className="bg-pastel-blush/70 backdrop-blur-md p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 border-2 border-pastel-pink/50 hover:border-interactive-pink/50 hover:scale-105">
              <div className="w-14 h-14 bg-interactive-pink/30 rounded-full flex items-center justify-center mb-6">
                <svg className="w-7 h-7 text-text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
              </div>
              <h3 className="text-xl font-bold text-text-primary mb-3">Turn Leads Into Customers On Autopilot</h3>
              <p className="text-text-secondary mb-4">
            ...
            <div className="bg-pastel-lavender/70 backdrop-blur-md p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 border-2 border-pastel-lavender/50 hover:border-interactive-blue/50 hover:scale-105">
              <div className="w-14 h-14 bg-interactive-blue/30 rounded-full flex items-center justify-center mb-6">
                <svg className="w-7 h-7 text-text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 12a9 9 0 01-9 9m9-9a9 9 0 00-9-9m9 9H3m9 9a9 9 0 01-9-9m9 9c1.657 0 3-4.03 3-9s-1.343-9-3-9m0 18c-1.657 0-3-4.03-3-9s1.343-9 3-9m-9 9a9 9 0 019-9" />
                </svg>
              </div>
              <h3 className="text-xl font-bold text-text-primary mb-3">Scale Without The Headache</h3>
              <p className="text-text-secondary mb-4">
            ...
            <div className="bg-pastel-periwinkle/70 backdrop-blur-md p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 border-2 border-pastel-periwinkle/50 hover:border-interactive-pink/50 hover:scale-105">
              <div className="w-14 h-14 bg-interactive-pink/30 rounded-full flex items-center justify-center mb-6">
                <svg className="w-7 h-7 text-text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
                </svg>
              </div>
              <h3 className="text-xl font-bold text-text-primary mb-3">Know Exactly What&apos;s Working</h3>
              <p className="text-text-secondary mb-4">
          ...
          <div className="text-center mt-16">
            ...
            <Button className="bg-interactive-pink hover:bg-interactive-pink/90 text-text-primary font-bold px-10 py-5 text-xl shadow-lg transition-all duration-300 transform hover:scale-105 border-2 border-interactive-pink/40">

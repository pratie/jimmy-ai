            ...
            <div className="space-y-8 md:space-y-10 max-w-2xl lg:max-w-none text-center lg:text-left">
              ...
              <div className="space-y-6">
                <h1 className="text-5xl sm:text-6xl md:text-7xl lg:text-[72px] font-extrabold text-gray-900 dark:text-white leading-[0.95] tracking-[-0.03em]">
                  <span className="block"><span className="relative text-transparent bg-clip-text bg-gradient-to-r from-[#68FBCE] via-[#5FE3B5] to-[#4FD1A0] text-stroke-black">AI</span> knowledge base</span>
                  <span className="block">and website <span className="relative text-transparent bg-clip-text bg-gradient-to-r from-[#68FBCE] via-[#5FE3B5] to-[#4FD1A0] text-stroke-black">assistant</span></span>
                </h1>
              </div>

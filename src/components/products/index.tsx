    ...
    <div>
      ...
      <TabsMenu
        ...
        button={
          ...
          customers."
              title="Add a product"
              className="flex items-center gap-2 bg-primary px-4 py-2 text-primary-foreground font-semibold rounded-lg text-sm"
              trigger={
                <>
                  <Plus
                    size={20}
                  ...
                  />
                  <p className="text-primary-foreground">Add Product</p>
                </>
              }
            >

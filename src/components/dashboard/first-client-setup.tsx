...
import { CTA_LABEL, useCreateClient } from '@/components/clients/use-create-client'
import { cd } from '@/lib/design-tokens'
import SetupPreview, { SourceCitation } from './setup-preview'
 ...
 *
 * The creation logic itself lives in `useCreateClient`, shared with the
 * roster's Add-client dialog so the first client and the fiftieth are created

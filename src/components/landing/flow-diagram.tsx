  ...
  return (
    <section className="relative py-12 md:py-20 bg-gradient-to-b from-transparent via-brand-base-100/30 to-transparent overflow-hidden">
      <div className="container mx-auto px-4">
          ...
          >
            <defs>
              <linearGradient id="pathGradient" x1="0%" y1="0%" x2="100%" y2="100%">
                <stop offset="0%" stopColor="#76fbd9" />
                <stop offset="50%" stopColor="#5b50e6" />
        ...
        <div className="md:hidden absolute left-12 top-48 bottom-48 w-1 bg-gradient-to-b from-[#76fbd9] via-[#5b50e6] to-[#22c55e] opacity-30 rounded-full" />
      </div>
    </section>
  )
}
